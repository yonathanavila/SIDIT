                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <div className="mt-8 flex gap-x-4 sm:justify-center">
                          <a href="#" className="inline-block rounded-lg bg-indigo-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-white-600 hover:bg-white-700 hover:ring-white-700">
                            Get started
                            <span className="text-white-200" aria-hidden="true">&rarr;</span>
                          </a>
                          <a href="#" className="inline-block rounded-lg px-4 py-1.5 text-base font-semibold leading-7 text-white-900 ring-1 ring-white-900/10 hover:ring-white-900/20">
                            Live demo
                            <span className="text-white-400" aria-hidden="true">&rarr;</span>
                          </a>
                        </div>
                      </div>
